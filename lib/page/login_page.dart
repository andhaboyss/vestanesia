...
class _LoginPageState extends State<LoginPage> {
  ...
  void _login() {
    ...
    if (isValid) {
      Navigator.pushNamed(context, AppRoutes.lengkapiData);
    }
  }
          ...
          children: <Widget>[
            ...
            Align(
              ...
              child: TextButton(
                ...
                child: const Text(
                  'Lupa password?',
                  style: TextStyle(color: Color(0xFF4CAF50), decoration: TextDecoration.underline), // Hijau
                ),
              ),
            ),
            ...
            Row(
              ...
              children: <Widget>[
                ...
                TextButton(
                  onPressed: () {
                    Navigator.pushNamed(context, AppRoutes.daftarPage);
                  },
                  child: const Text(
                    'Daftar di sini',
                    style: TextStyle(
